...
namespace DebtsApp.Web.Migrations
{
    ...
    [Migration("20191003152154_Change-Debt-Schema")]
    partial class ChangeDebtSchema
    {
            ...
            modelBuilder.Entity("DebtsApp.Web.Database.Models.Debt", b =>
                {
                    ...
                    b.Property<bool>("IsMyDebt")
                        .HasColumnName("is_my_debt");

                    b.Property<long?>("OtherContactId")
                        .HasColumnName("other_contact_id");
                    ...
                    b.HasIndex("OtherContactId")
                        .HasName("ix_debts_other_contact_id");

                    b.HasIndex("OtherUserId")
                        .HasName("ix_debts_other_user_id");
            ...
            modelBuilder.Entity("DebtsApp.Web.Database.Models.Debt", b =>
                {
                    ...
                    b.HasOne("DebtsApp.Web.Database.Models.Contact", "OtherContact")
                        .WithMany()
                        .HasForeignKey("OtherContactId")
                        .HasConstraintName("fk_debts_contacts_other_contact_id");

                    b.HasOne("DebtsApp.Web.Database.Models.User", "OtherUser")
                        .WithMany()
                        .HasForeignKey("OtherUserId")
                        .HasConstraintName("fk_debts_users_other_user_id");
                });
